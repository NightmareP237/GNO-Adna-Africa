...
import 'package:adna/screens/checkout/views/thanks_for_order_screen.dart';
import 'package:adna/screens/language/view/select_language_screen.dart';
import 'package:adna/screens/payment/views/add_new_card_screen.dart';
  ...
  switch (settings.name) {
     case statusAuth:
      return MaterialPageRoute(
        builder: (context) => const StatutAuth(),
      );
